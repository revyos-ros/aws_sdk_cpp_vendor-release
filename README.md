...
## aws_sdk_cpp_vendor (iron) - 0.2.1-1

The packages in the `aws_sdk_cpp_vendor` repository were released into the `iron` distro by running `/home/daisuke/.local/bin/bloom-release aws_sdk_cpp_vendor -r iron` on `Wed, 27 Sep 2023 15:54:42 -0000`
...
## aws_sdk_cpp_vendor (rolling) - 0.2.1-1

The packages in the `aws_sdk_cpp_vendor` repository were released into the `rolling` distro by running `/home/daisuke/.local/bin/bloom-release aws_sdk_cpp_vendor -r rolling` on `Wed, 27 Sep 2023 15:52:40 -0000`
...
## aws_sdk_cpp_vendor (rolling) - 0.2.0-1

The packages in the `aws_sdk_cpp_vendor` repository were released into the `rolling` distro by running `/home/daisuke/.local/bin/bloom-release aws_sdk_cpp_vendor -r rolling` on `Mon, 25 Sep 2023 16:07:44 -0000`
...
## aws_sdk_cpp_vendor (iron) - 0.2.0-1
